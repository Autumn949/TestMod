...
public class TestCraftingContainer extends Container{
    ...
    public TestCraftingContainer(int p_i50090_1_, PlayerInventory p_i50090_2_, PacketBuffer packet) {
        this(p_i50090_1_,p_i50090_2_,getPos(p_i50090_2_, packet));
    }

    public TestCraftingContainer(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_) {
super(RegisterBlocks.TESTCRAFTINGBLOCKCONTAINER.get(),p_i50090_1_);
    ...
    public boolean stillValid(PlayerEntity p_75145_1_) {
        return stillValid(access,p_75145_1_,RegisterBlocks.TESTCRAFTINGBLOCK.get());
    }
