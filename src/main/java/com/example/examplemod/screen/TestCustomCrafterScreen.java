...
public class TestCustomCrafterScreen extends ContainerScreen<TestCustomCrafterContainer> {
    ...
    public TestCustomCrafterScreen(TestCustomCrafterContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
